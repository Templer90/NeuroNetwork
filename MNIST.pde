...
//"Inspired" (shamelessly stolen) from https://stackoverflow.com/questions/8286668/how-to-read-mnist-data-in-c; Vivin Paliath 
public class MNISTLoadingService {
  ...
  public MNISTLoadingService(String labelFileName, String imageFileName) {
    this.labelFileName = labelFileName;
    this.imageFileName = imageFileName;
  }

  public List<MNIST> loadDigitImages() throws IOException {
    List<MNIST> images = new ArrayList<MNIST>();
